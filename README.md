...
runcmd:
  - "curl -s https://raw.githubusercontent.com/silviupanaite/hetzner-cloud-init/master/setup.sh | bash -s -- --hcloud-token <TOKEN> --whitelisted-ips <WHITELIST> --floating-ips"
```
